...
export default function ReviewCard({ data }: ReviewCardProps) {
  ...
  return (
    <div className="bg-white rounded-3xl p-6 flex flex-col h-full">
      ...
      <p className="text-black font-parkinsans text-lg leading-relaxed mb-6 overflow-hidden" style={{ display: '-webkit-box', WebkitLineClamp: 4, WebkitBoxOrient: 'vertical' }}>
        "{data.text}"
      </p>
