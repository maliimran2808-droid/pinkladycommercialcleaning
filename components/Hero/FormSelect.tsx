  ...
  ({ options, error, className = '', ...props }, ref) => {
    return (
      <div className="flex flex-col w-full">
        <select
          ref={ref}
          className={`w-full px-4 py-3.5 bg-white border ${error ? 'border-red-400 focus:ring-red-300' : 'border-gray-200 focus:ring-luxury-pink'} rounded-md text-sm text-gray-800 focus:outline-none focus:ring-2 appearance-none cursor-pointer transition-all duration-200 ${className}`}
          style={{
